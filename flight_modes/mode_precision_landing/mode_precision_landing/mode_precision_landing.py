...
class ModePrecisionLanding(Node):
    ...
    def __init__(self):
        ...
        # settings
        self.landing_speed_gain = 0.035 # m, how far the position setpoint should be from the current position of the drone, translates proportionally to landing speed
